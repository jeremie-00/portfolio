...
export const headerVariants = cva(
  "w-full flex items-center justify-center bg-background", // Classes de base
  {
    variants: {
      variant: {
        default: " py-4 px-8",
        sticky: "sticky top-0 z-10 shadow dark:shadow-primary/40",
      },
      size: {
        sm: "text-sm",
        md: "text-md",
...
export const headerLinkVariants = cva(
  "rounded-md cursor-pointer group relative flex items-center gap-2 text-foreground transition-colors duration-300 after:bg-primary after:transition-scale after:duration-300", // Classes de base
  {
    variants: {
      variant: {
